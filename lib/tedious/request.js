...
const { IDS, objectHasProperty, assertSafeColumnName } = require('../utils')
      ...
      this.parent.acquire(this, (err, connection) => {
        ...
        try {
          for (const col of table.columns) {
            ...
            bulk.addColumn(assertSafeColumnName(col.name), getTediousType(col.type), { nullable: col.nullable, length: col.length, scale: col.scale, precision: col.precision })
          }
