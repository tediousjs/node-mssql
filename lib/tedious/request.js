...
const { IDS, objectHasProperty, assertSafeColumnName, assertSafeTypeSize } = require('../utils')
  ...
  _execute (procedure, callback) {
    super._execute(procedure, err => {
      ...
      this.parent.acquire(this, (err, connection, config) => {
        ...
        // relabel a rejected size as EREQUEST, so anything that can throw here is handed
        // back through this instead, which keeps the code and releases the connection.
        const abandon = (err) => {
          delete this._cancel
