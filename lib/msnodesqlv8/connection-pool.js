...
const CONNECTION_DRIVER = process.env.mssql_msnodesqlv8_CONNECTION_DRIVER ?? (
  ['darwin', 'linux'].includes(platform()) ? 'ODBC Driver 17 for SQL Server' : 'SQL Server Native Client 11.0'
)
