...
const parseConnectionString = function parseConnectionString(string) {
	let cursor = 0;
	let parsing = 'name';
	let param = null;
	let buffer = '';
...
const resolveConnectionString = function resolveConnectionString(string) {
	...
	if (parsed.driver === 'msnodesql' || parsed.driver === 'msnodesqlv8') {
