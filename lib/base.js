...
class ConnectionPool extends EventEmitter {
  ...
  query () {
    if (typeof arguments[0] === 'string')
      return new driver.Reuqest(this).query(arguments[0], arguments[1])
  ...
  batch () {
    if (typeof arguments[0] === 'string')
      return new driver.Reuqest(this).batch(arguments[0], arguments[1])
...
module.exports.exports.query = function query () {
  if (typeof arguments[0] === 'string')
    return new driver.Reuqest().query(arguments[0], arguments[1])
...
module.exports.exports.batch = function batch () {
  if (typeof arguments[0] === 'string')
    return new driver.Reuqest().batch(arguments[0], arguments[1])
