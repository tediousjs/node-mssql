...
const getMssqlType = function (type, length) {
  switch (type) {
    ...
    case tds.TYPES.Time: case tds.TYPES.TimeN: return TYPES.Time
    case tds.TYPES.Date: case tds.TYPES.DateN: return TYPES.Date
    case tds.TYPES.DateTime2: case tds.TYPES.DateTime2N: return TYPES.DateTime2
    case tds.TYPES.DateTimeOffset: case tds.TYPES.DateTimeOffsetN: return TYPES.DateTimeOffset
    case tds.TYPES.SmallDateTime: return TYPES.SmallDateTime
    case tds.TYPES.UniqueIdentifier: case tds.TYPES.UniqueIdentifierN: return TYPES.UniqueIdentifier
