...
const {TYPES, declare, cast} = require('./datatypes');
...
class ConnectionPool extends base.ConnectionPool {
	...
	batch(...args) {
		return super.batch(Request, ...args);
	}
}

class PreparedStatement extends base.PreparedStatement {
	_prepare(...args) {
		return super._prepare(Request, ...args);
	}
	
	_execute(...args) {
		return super._execute(Request, ...args);
	}
	
	_unprepare(...args) {
		return super._unprepare(Request, ...args);
	}
}
...
module.exports.connect = module.exports.connect.bind(null, ConnectionPool);
module.exports.query = module.exports.query.bind(null, Request);
module.exports.batch = module.exports.batch.bind(null, Request);

module.exports.ConnectionError = base.ConnectionError;
module.exports.TransactionError = base.TransactionError;
module.exports.RequestError = base.RequestError;
module.exports.PreparedStatementError = base.PreparedStatementError;
